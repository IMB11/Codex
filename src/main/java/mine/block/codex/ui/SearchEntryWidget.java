...
public class SearchEntryWidget extends EmptyWidget {
    ...
    public SearchEntryWidget(QuicksearchScreen quicksearchUI, SearchResult searchResult, int width, int height) {
        super(width, height);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (CodexClient.OPEN_RECIPE_SUPPLIER == null) {
            return false;
        }
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        MinecraftClient.getInstance().setScreen(new CodexScreen(this.result, this.parent));
